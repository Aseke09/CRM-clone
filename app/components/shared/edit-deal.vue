...
<template>
	<UModal v-model:open="isLocalOpen">
      <template #content>
        <div class="p-4">
			...
			>
				<UFormField label="Name" name="name">
					<UInput v-model="state.name" color="info" size="xl" class="w-full"/>
				</UFormField>

				<UFormField label="Description" name="description">
					<UTextarea v-model="state.description" color="info" size="xl" class="w-full" />
				</UFormField>
