...
export const DB_ID = '689eeb0e002c811741d4'
export const COLLECTION_DEALS = '689eecd900138b7c8c9b'
export const COLLECTION_COMMENTS = '689ef4b200326ee28ece'

export interface MyTabItem extends TabsItem {
	label: string
  description: string
  image: string
  credentials: {
