...
<template>
  <div class="grid grid-cols-4 gap-2 mt-12" v-if="isLoading">
    <USkeleton class="h-12 dark:bg-gray-900 bg-gray-200"/>
    <USkeleton class="h-12 dark:bg-gray-900 bg-gray-200"/>
    <USkeleton class="h-12 dark:bg-gray-900 bg-gray-200"/>
    <USkeleton class="h-12 dark:bg-gray-900 bg-gray-200"/>
    ...
    <div class="grid grid-cols-4 gap-2 mt-12" v-else>
      ...
      >
        ...
        <div 
          class="my-3 dark:bg-gray-900 bg-gray-200 rounded-md p-2 animation" 
        ...
        >
          ...
          >
            ...
            <Icon name="material-symbols:arrow-forward" class="group-hover:translate-x-2 transition"/>
          </UButton>
        </div>
      </div> 
