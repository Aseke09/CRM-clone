...
import { tabs, type MyTabItem, templates } from '@/constants';
  ...
  <main>
    ...
    bg-gradient-to-t from-white dark:from-black to-blue-500 dark:to-blue-800">
        <div class="pl-20 flex flex-col space-y-3">
		  ...
		  <templates v-if="currentUser.status">
			<NuxtLink to="/auth">
				<UButton color="info">
				  Documents
				</UButton>
		  ...
		  <templates v-else>
            <NuxtLink to="/auth">
              <UButton color="info"> Try it free </UButton>
            </NuxtLink>
		  </templates>
        </div>
    ...
    <section>
      ...
      <UTabs  
        ...
        <template #content="{ item }: { item: MyTabItem }">
